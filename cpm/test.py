...
if __name__ == "__main__":
    ...
    parser.add_argument('--epochs-train', type=int, default=60, metavar='N',
                        help='number of epochs to train [default: 30]')
    parser.add_argument('--epochs-test', type=int, default=60, metavar='N',
    ...
    #                args.lamb, args.beta).cuda()
    #model_state_dict=torch.load(os.path.join('pts', args.dataset, str(args.seed), f'{str(args.beta)}.pt'))
    #print(os.path.join('pts', args.dataset, str(args.seed), f'{str(args.beta)}.pt'))
    #exit()
    #model=model.to(device)
    ...
    for num in range(input_num):
        ...
        logger.info('{},{},{},{:.4f},{:.4f},{:.4f},{:.4f},{:.4f},{:.4f}'\
            .format(args.seed, args.beta, num, acc, nll, aurc, eaurc, aupr, fpr))
    ...
    #ave_conf = []
    #for num in range(input_num):
    #    ave_conf.append(np.mean(confidence_list[num]))
    #print(ave_conf)